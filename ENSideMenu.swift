...
open class ENSideMenu : NSObject, UIGestureRecognizerDelegate {
    ...
    open var menuWidth : CGFloat = 300.0 {
        didSet {
    ...
    */
    public init(sourceView: UIView, menuPosition: ENSideMenuPosition, blurStyle: UIBlurEffectStyle = .light) {
        ...
        sideMenuContainerView.addGestureRecognizer(self.containerViewTapGesture)
    ...
    */
    ...
    func didtapContainerView(_ gesture: UITapGestureRecognizer) {
        if isMenuOpen {
